...
import { useAddPostMutation, useGetPostsQuery, useUpdatePostMutation } from 'pages/blog/blog.service'
...
export default function CreatePost() {
  ...
  const { data } = useGetPostsQuery(postId, { skip: !postId })
      ...
      <div className='mb-6'>
        ...
        <input
          ...
          className={classNames(
            ...
            {
              'border-red-500 border-red-500 bg-red-50 text-red-900 placeholder-red-700 focus:border-red-500 focus:ring-blue-500':
